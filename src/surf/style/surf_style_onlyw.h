...
class SurfOnlyWStylePlugin : public ISmmPlugin, public IMetamodListener
{
public:
...
public:
	...
	const char *GetName()
	{
		return "CS2Surf-Style-OnlyW";
	}

	const char *GetDescription()
	{
		return "OnlyW style plugin for CS2Surf";
	}
...
class SurfOnlyWStyleService : public SurfStyleService
{
