...
class SurfSidewaysStylePlugin : public ISmmPlugin, public IMetamodListener
{
public:
...
public:
	...
	const char *GetName()
	{
		return "CS2Surf-Style-Sideways";
	}

	const char *GetDescription()
	{
		return "Sideways style plugin for CS2Surf";
	}
...
class SurfSidewaysStyleService : public SurfStyleService
{
